...
checksum:
  algorithm: sha256
  hash: 5f271f7a4867666973398e23c0d60861ec717a6e7e4523c918614bc9247dd174
name: test-coverage-gap-analysis
objective: Analyze test files against project structure to identify untested code
  paths, controllers, routes, and functions. Supports Jest, Mocha, Vitest, and other
  test frameworks.
