...
checksum:
  algorithm: sha256
  hash: b600bc06da59c5d2d7d6e3d3abf1590a38223ed81cead51fd98612e54ac7dbf5
name: code-refactoring-abstraction
objective: Analyze code for DRY violations and repetitive patterns, then suggest abstractions
  to reduce duplication. Supports TypeScript/JavaScript, Python, and Go with configurable
  output modes.
