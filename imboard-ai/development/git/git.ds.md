...
checksum:
  algorithm: sha256
  hash: 8b74415b228311bd4d626caa70e6f792534d711e159c46483997507c4371f471
...
objective: Restructure a git project to support git worktrees by moving repository
  contents into a main/ subdirectory and creating a worktree registry for tracking
  active work
outputs:
  configuration:
...
risk_level: high
rollback:
  instructions: Move all contents from main/ back to parent directory and delete the
...
signature:
  ...
  signature: nSCgNo1STdadVzn3iN+8vEUCLok4XDK32Akvs9NBuSU01U7YC05+dcfgaPeNSwbSKk9YklzxXsFnHpuS9BPGAw==
  signed_by: Yuval Dimnik <yuval.dimnik@gmail.com>
  timestamp: '2025-12-17T06:29:12.969033+00:00'
status: stable
tags:
- git
- worktrees
...
**Ask user**:
```
SAFETY CHECK #2: External Backup
...
**Show warning**:
```
FINAL WARNING: High-Risk Directory Restructuring
...
# Option 2: Force remove (DATA LOSS - uncommitted changes deleted)
